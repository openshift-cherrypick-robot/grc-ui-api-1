...
export const mockNewAPISinglePolicyResponse = {
  ...
  metadata: {
    ...
    namespace: 'calamari',
    ownerReferences: [{
      apiVersion: 'policies.open-cluster-management.io/v1', blockOwnerDeletion: true, controller: true, kind: 'Policy', name: 'case1-test-policy', uid: 'e919bf5c-df16-4b90-ae01-a39da7138623'
    }],
